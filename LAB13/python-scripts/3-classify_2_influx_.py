...
INFLUXDB_TOKEN = "O-iiMz5nWitpz6dk2hpTjMCvtFj4uyt-RYC2tok_2BU5LF8PAQwQOayf4e85eSUWD2Ubtjold6KOfPuRgSyRKA=="  # Replace with your InfluxDB token
INFLUXDB_ORG = "IOT-LAB13"      # Replace with your InfluxDB organization name
INFLUXDB_BUCKET = "LAB13"  # InfluxDB bucket name

# MQTT setup
MQTT_BROKER = "192.168.18.31"  # ESP32's MQTT broker address
